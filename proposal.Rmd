...
- Value of given/taken ($): if a positive or negative policy is put in place, the value of funds/goods wagered will influence the number of Americans that will comply. 
...
|--------------------------|-------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|-------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|
| Monetary Incentive       | A pure monetary incentive given to those who choose to receive the vaccine (not retroactive)                      | Value of incentive ($50 - $1000 with $50 increments)                     | Public approval, doesn't interfere with individual rights                                                          | Expensive, less effective than mandates                                                                                                                          |
| Vaccine Mandate          | A tax penalty for those who do not comply to a vaccine mandate, enforced with tax returns.             | Value of fine ($50 - $1000 with $50 increments)                          | Government income, easy logistics, compatible with tax system  | [Public outrage and pushback,](https://youtu.be/bFk45V9wEQ4), may infringe on individual rights                                                                                                      |
