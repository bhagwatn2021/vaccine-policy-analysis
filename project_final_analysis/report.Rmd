...
|      Resistance     | Number of Respondents |
|:-------------------:|:---------------------:|
|    No Resistance    |           12          |
|        Mixed        |           47          |
| Complete Resistance |           48          |

From our data we identified different groups with different levels of resistance to the COVID-19 vaccine. The no resistance group consisted of 12 survey respondents who chose to take the vaccine for all 10 choice questions. The mixed resistance group consisted of 47 survey respondents who sometimes chose to take the vaccine and sometimes did not choose to take the vaccine. The complete resistance group consisted of 48 respondents who chose not to take the vaccine under any conditions.
...
## Plotting subgroup coefficients
We plotted the model coefficients and a 95% confidence interval for all continuous attributes, regressing attribute value onto utility from that attribute, with each coefficient being the slope. We also plotted each categorical attribute coefficient and a 95% confidence interval, with each coefficient representing the total utility from the respective attribute.

### Baseline model
We plotted the baseline model attributes. We found that the general sample had a favorable view towards incentives (prefer to take the vaccine with incentives) as utility is positively correlated with incentive value, but an unfavorable view for fines (prefer not to take the vaccine with fines) as utility is negatively correlated with penalty value. Moreover, respondents prefer grocery store gift cards the most. We also saw that respondents in general preferred vaccination centers within 3 miles of residences over door-door vaccinations.

### Resistant model
We plotted the model attributes for resistant respondents, with non-resistant respondents as a reference. We found resistant respondents had an unfavorable view towards incentives as utility is negatively correlated with incentive value, and an unfavorable view for fines as utility is also negatively correlated with penalty value. However, resistant respondents seem to be slightly less sensitive to fines, but there is a high confidence interval for this attribute that spans 0, indicating that there is a high degree of uncertainty about the actual utility term for this attribute. Moreover, we found that resistant respondents. We also saw that respondents in general preferred door-door vaccinations and preferred cash as an incentive, however there is a high confidence interval for these attributes that spans 0, limiting our accuracy as to the actual coefficients.

### Political model
We plotted the model attributes for conservative, liberal, and independent respondents, using moderate respondents as a reference. We found respondents in political groups have a favorable view towards incentives as utility is positively correlated with incentive value, and an unfavorable view for fines as utility is also negatively correlated with penalty value. Liberal and conservative respondents did not seem to be persuaded by incentives, given that incentive value is not correlated with utility, and the coefficients for those groups is close to 0, but they had a more favorable view on penalties given the positive correlation between penalty value and utility. Independents seemed to have a more favorable view on penalties and a more unfavorable view on incentives, given the correlation between value and utility. Respondents of a political party (liberal, conservative, independent) tended to prefer vaccination centers, with a slight preference towards vaccination centers 3 miles or less from residences, given higher coefficients for those subgroups. Also given higher coefficients,conservative and independent respondents also prefer internet the most, while liberal respondents prefer cash more than other incentives. However, there is a high confidence interval that spans 0 across most subgroups and continuous attributes, indicating that there is massive uncertainty about the value of the coefficients.

### Income model
We plotted the model attributes for low-income and high-income respondents. We found that utility for low-income respondents with regards to penalties and incentives is positively correlated with both penalty value and incentive value, indicating that they are more favorable towards those policies. The expected coefficient for incentive value is close to 0 with high-income respondents, indicating that they are indifferent about incentives. However, the coefficient for penalties with high-income respondents is much higher, in the positive range, indicating more favorability towards penalties. Moreover, based on the coefficients, we found that low-income respondents in the sample slightly prefer internet rebates and vaccination centers within 10 miles, and that high-income respondents in the sample slightly prefer grocery store gift cards and vaccination centers within 10 miles. However, the high confidence interval in all attributes prevents us from making accurate guesses.

### Ethnicity model
We plotted the model attributes for Asian, Black, Hispanic, and Native respondents. Given the positive expected coefficients for Native respondents with regards to incentive value, and the negative coefficients for Black, Asian, and Hispanic respondents with regards to incentive value, we found that Native respondents have a favorable view to incentives, while Black, Asian, and Hispanic respondents have a more unfavorable view on incentives. We also found that Black respondents have a more favorable view on penalties, while Asian, Hispanic, and Native respondents have a more unfavorable view on penalties for non-compliance with vaccine mandates. We also found based on the categorical coefficients that Asian respondents prefer to travel within 1 mile to get a vaccine dose, Hispanic and Native respondents are willing to travel 3 miles, and Black respondents are willing to travel 10 miles. Finally, we found based on model coefficients that Asian respondents slightly preffered grocery store gift cards over cash, and majorly preferred grocery store gift cards over internet rebates and sporting event tickets, that Native respondents mostly prefer grocery store gift cards as incentives, that Hispanic respondents have a favorable view on non-cash incentives, and that Black respondents have a preference towards grocery store gift cards and sporting event tickets.

### Education model
We plotted the model attributes for less-educated and more-educated respondents. We found that utility for less-educated respondents with regards to penalties is positively correlated with penalty value, and that utility for less-educated respondents with regards to incentives is positively correlated with incentive value, although the coefficient for incentive value is close to 0. The expected coefficients for incentive value and penalty is postive with more-educated respondents, indicating that they are more likely to take the COVID-19 vaccine under incentives or penalties. Moreover, based on the coefficients, we found that less-educated respondents in the sample prefer internet rebates and vaccination centers within 3 miles of their residences, although some less-educated respondents are open to travelling 10 miles to get a vaccine, and that more-educated respondents in the sample slightly prefer internet rebates and vaccination centers within 3 miles. However, the high confidence interval that spans 0 in all attributes prevents us from making accurate guesses.
